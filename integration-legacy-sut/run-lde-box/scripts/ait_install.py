...
import time
import sys, getopt
# TODO: Use the functions from cirpa utils and remove imports
...
def remote_copy(sshClient, local, remote):
    ...
    if os.path.isfile(local):
        ...
        print("SWP file does not exist {}".format(local))
        sys.exit(1)
...
def main(argv):
    ...
    stdin,stdout,stderr = ssh.exec_command("mkdir -p " + home_ait)
