...
class IntegrationTestCsm(StartBase):
    ...
    def arguments(self, parser):
        ...
        parser.add_argument('--securityalarmlogging', dest="securityalarmlogging", type=Optional)
    ...
    def set_path(self, os, target):
        ...
        self.add_argument("securityalarmlogging", Optional(""))
    ...
    def __init__(self):
        ...
        self._filesToRemove = ["/configdrive.iso", "/ldews-ict.box"]
    ...
    def execute(self, args):
        if args["suite"].startswith("comsa"):
            print "Starting the SLES12 comsa test"
            returnValue = self._runSutImage(["comsatest"], args)
            if returnValue == 0:
                returnValue = self._runTeImage(["comsatest"], args)
        else:
        ...
        if self._sutImageName:
            try:
                ...
                if versionFile:
                    ...
                    if args["suite"] == "integration_bfu_csm" or args["suite"] == "integration_bfu_onestep_csm":
                ...
                if args["securityalarmlogging"]:
                    parameter += [args["securityalarmlogging"]]
                ...
                try:
                    ...
                    docker.cp_from(self.__sutContainerId, "/ldews-ict.box", "/")
                    docker.cp_from(self.__sutContainerId, "/configdrive.iso", "/")
    ...
    def _runTeImage(self, params, args):
        returnValue = 0
        esmBoxName = "ldews-ict.box"
        configDriveName = "configdrive.iso"
        distDir = "dist/"
        ...
        if self._teImageName:
            ...
            try:
                ...
                if not args["suite"].startswith("comsa"):
                ...
                docker.cp_to(self.__teContainerId, configDrive, dest)
                ...
                try:
                    ...
                    if args["suite"].startswith("comsa"):
                        src = os.path.join(self._workDir, "/proj/coremw_scratch/root/logs/")
                        # copy files
