from fmcorefunctiontest import FmCoreFunctionTest


class FunctionTestSles12FmCore(FmCoreFunctionTest):
    ...
    def __init__(self):
        ...
        FmCoreFunctionTest.__init__(self)
        ...
        self._filesToCopy = ["/build/fmcore-build/gen"]
