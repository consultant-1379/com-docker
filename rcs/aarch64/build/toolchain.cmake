...
#
# Cmake toolchain file for RCS arm64
#
...
set(CMAKE_C_FLAGS "--sysroot=${SYSROOT} -D_DEFAULT_SOURCE -Werror -pedantic -pedantic-errors -fno-strict-aliasing " CACHE STRING "" FORCE)    # C Compiler flags
set(CMAKE_CXX_FLAGS "--sysroot=${SYSROOT} -D_DEFAULT_SOURCE -Werror -pedantic -pedantic-errors -fno-strict-aliasing " CACHE STRING "" FORCE)  # C++ Compiler flags
set(CMAKE_EXE_LINKER_FLAGS "")  # Linker flags
