...
set(SYSROOT_LD_LIBRARY_PATH "${SYSROOT}/lib:${SYSROOT}/usr/lib")
...
set(CMAKE_EXE_LINKER_FLAGS "-Wl,--dynamic-linker=${SYSROOT}/lib/ld-linux.so.2" CACHE STRING "" FORCE) # Linker flags
